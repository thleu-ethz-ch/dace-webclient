...
export default class Bench {
    ...
    public static GRAPHS_LARGE = ["bert", "lulesh-with-maps", "unreadable", "rgf_dense"];
    public static GRAPHS_ALL = ["bert", "gemm_opt", "jacobi", "lulesh-with-maps", "placement", "rgf_dense", "symm", "syrk", "trisolv", "trmm", "unreadable", "wrong"];
