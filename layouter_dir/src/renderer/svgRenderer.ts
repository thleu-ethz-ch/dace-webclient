...
export default class SvgRenderer extends Renderer {
    ...
    protected _render(graph: RenderGraph, view: any = "auto"): void {
        ...
        if (view !== null) {
            if (view === "auto") {
                ...
                this._container.setZoom(view.zoom);
                this._container.translate(new Vector(view.centerX, view.centerY));
            }
        }
